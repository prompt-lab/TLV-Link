...
class TAGDataset(Dataset):
    def __init__(self, args, mode='train'):
        ...
        if mode == 'train':
            if args.cls_mode == 'rough':
                self.txt = '/data/develop/smallz/TLV-Core/tactile_datasets/train/TAG/train_rough.txt'
            elif args.cls_mode == 'material' or args.cls_mode == 'hard':
                self.txt = '/data/develop/smallz/TLV-Core/tactile_datasets/train/TAG/train.txt'
        else:
            if args.cls_mode == 'rough':
                self.txt = '/data/develop/smallz/TLV-Core/tactile_datasets/train/TAG/test_rough.txt'
            elif args.cls_mode == 'material' or args.cls_mode == 'hard':
                self.txt = '/data/develop/smallz/TLV-Core/tactile_datasets/train/TAG/test.txt'
        ...
        self.transform = get_touch_transform(args)
...
def get_tag_dataset(args, mode='test'):
    # Create dataset using TAGDataset
    dataset = TAGDataset(args, mode=mode)
