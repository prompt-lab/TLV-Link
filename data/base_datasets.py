...
octopi_dir = '/data/develop/smallz/TLV-Core/tactile_datasets/octopi/'
...
octopi_file = '/data/develop/smallz/TLV-Core/tactile_datasets/contact_text_octopi.csv'
TVL_file = '/data/develop/smallz/TLV-Core/tactile_datasets/contact_text_tvl.csv'

tacquad_indoor_dir = '/data/develop/smallz/TLV-Core/tactile_datasets/tacquad/data_indoor/'
tacquad_outdoor_dir = '/data/develop/smallz/TLV-Core/tactile_datasets/tacquad/data_outdoor/'

tacquad_indoor_file = '/data/develop/smallz/TLV-Core/tactile_datasets/tacquad/contact_indoor.csv'
tacquad_outdoor_file = '/data/develop/smallz/TLV-Core/tactile_datasets/tacquad/contact_outdoor.csv'

tacquad_text_dir = '/data/develop/smallz/TLV-Core/tactile_datasets/text_tacquad/'
